...
function AdminRecycleBin() {
    ...
    const fetchDeleted = async () => {
        try {
            setLoading(true);
            const res = await axios.get("https://datregdatabase-1.onrender.com/api/students/recyclebin");
    ...
    const handleRestore = async (id) => {
        ...
        try {
            await axios.put(`https://datregdatabase-1.onrender.com/api/students/restore/${id}`);
    ...
    const handlePermanentDelete = async (id) => {
        ...
        try {
            await axios.delete(`https://datregdatabase-1.onrender.com/api/students/permanent/${id}`);
